 ...
 */
class MyFragmentChild1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_my_child1, container, false)
    }
...
//    var items2:ArrayList<Item> = arrayListOf()
    ...
    companion object {
         ...
         * @return A new instance of fragment MyFragmentChild1.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MyFragmentChild1().apply {
