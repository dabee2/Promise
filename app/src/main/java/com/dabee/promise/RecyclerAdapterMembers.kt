...
class RecyclerAdapterMembers constructor(val context:Context, var items:MutableList<FriendsItem>): RecyclerView.Adapter<RecyclerAdapterMembers.VH>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        val itemView:View = layoutInflater.inflate(R.layout.recycler_item_members,parent,false)
